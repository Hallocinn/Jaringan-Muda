    ...
    <div class="saintifik-content" style="margin-top: 20px;">
        <div class="step" id="step1" style="display: block;">
            <div class="card">
                ...
                <div class="card">
                <h3>Definisi</h3>
                <p>Tanaman memiliki kemampuan untuk menumbuhkan organ baru sebagai bagian dari proses pertumbuhan serta untuk menggantikan organ yang rusak atau hilang. Proses tersebut terjadi karena adanya jaringan muda yang disebut jaringan meristem. Jaringan meristem merupakan jaringan pada tumbuhan yang sel-selnya aktif membelah, sehingga berperan penting dalam pertumbuhan tanaman. Melalui pembelahan sel yang berlangsung secara terus-menerus, jaringan meristem menghasilkan sel-sel baru yang kemudian berkembang menjadi berbagai jaringan dan organ tumbuhan. Oleh karena itu, jaringan meristem bertanggung jawab terhadap pertambahan tinggi batang, pertambahan panjang akar, serta pembentukan organ baru seperti daun, bunga, dan buah. </p>
            </div>
        </div>
