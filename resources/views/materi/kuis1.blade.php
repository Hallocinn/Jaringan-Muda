...
{{-- ================= AREA PETUNJUK KUIS ================= --}}
    ...
    <h3 class="petunjuk-title">Definisi Jaringan Muda Tumbuhan</h3>
    ...
    <div id="hasilIcon" class="icon-success"></div> 
    ...
    <p id="pesanMotivasi" class="motivasi-text"></p>
            ...
            <div class="info-box-blue">
                ...
                <div>
                    Sistem menyimpan <strong>Nilai Tertinggi</strong> dari seluruh percobaan.
            ...
            <div class="hasil-action" id="actionButtons">
                ...
                <a href="{{ route('materi2') }}" class="btn-next-materi" id="btnMateriSelanjutnya">
                    Lanjut Materi 2 <i class="fas fa-arrow-right" style="margin-left: 8px;"></i>
                </a>
            </div>
...
<script>
    ...
    const keyPercobaan = 'percobaanKuis1_user_' + userId;
    const keyJawaban = 'jawabanKuis1_Siswa_user_' + userId;
    ...
    async function mulaiKuis() {
        if(dataSoal.length === 0) {
            panggilAlertCustom({ judul: "Opps! Soal Kosong", pesan: "Guru belum menginput soal untuk Kuis 1 ini.", tipe: "danger" });
            return;
        }
    ...
    async function eksekusiSelesaiKuis() {
        ...
        try {
            await fetch("{{ route('kuis1.simpan') }}", {
                method: 'POST',
                headers: {
